...
class SQLScreen(QDialog):
    def __init__(self):
        ...
        loadUi('assets/ui/sql-screen.ui', self)
...
class CreateAccScreen(QDialog):
    def __init__(self):
        ...
        loadUi('assets/ui/create-acc.ui', self)
        self.password_line_edit.setEchoMode(QtWidgets.QLineEdit.Password)
...
class MainScreen(QDialog):
    def __init__(self):
        ...
        loadUi('assets/ui/main-screen.ui', self)
...
class ButtonRedirect(QDialog):
    def __init__(self, button_num):
        ...
        loadUi('assets/ui/expanded-book.ui', self)
        _translate = QtCore.QCoreApplication.translate
        # Thumbnail
        ...
        try:  # Checks if comments for particular book exist else goes to except
            ...
            for i in range(len(bgfns.insertcomment(cur1, book_id_list[button_num], False))):
                ...
                self.default_avatar.setPixmap(QtGui.QPixmap("assets/images/default avatar.png"))
                ...
                if username in admin_list or username == bgfns.insertcomment(cur1, book_id_list[button_num], False)[i][
                    ...
                    self.remove_icon.setPixmap(QtGui.QPixmap("assets/images/remove_icon.png"))
                    ...
                    if username in admin_list:
                        ...
                        self.ban_icon.setPixmap(QtGui.QPixmap("assets/images/ban_icon.png"))
